...
// ... (calculate_dynamic_fee reste inchangée car elle n'utilisait pas uint)
pub fn calculate_dynamic_fee(
    ...
    let dynamic_fee_rate_u256: U256 = U256::from(capped_volatility) * U256::from(variable_fee_control) * U256::from(base_fee_rate) / U256::from(VOLATILITY_FEE_PRECISION);
