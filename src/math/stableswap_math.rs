// DANS : src/math/stableswap_math.rs
...
/// Calcule l'invariant 'D' de la courbe.
fn get_d(reserve_a: u128, reserve_b: u128, amp: u64) -> Result<u128> {
    ...
    for _ in 0..64 {
        // TOUTES les variables sont converties en U256 avant les opérations
...
/// Calcule la nouvelle réserve de sortie 'y' pour une réserve d'entrée 'x'.
...
/// La fonction principale qui calcule le montant de sortie.
pub fn get_quote_for_stableswap(
    amount_in: u64, in_reserve: u64, out_reserve: u64, amp: u64,
) -> Result<u64> {
